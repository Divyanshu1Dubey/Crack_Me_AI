/**
 * api.ts — USMLE site. Mirrors the NEET PG api.ts but with `exam_type="usmle"`
 * baked into every question request.
 */
...
export const questionsAPI = {
    list: (params: Record<string, unknown> = {}) =>
        apiClient.get("/questions/", { params: { ...params, exam_type: "usmle" } }),
    get: (id: number) => apiClient.get(`/questions/${id}/`),
    getSubjects: () => apiClient.get("/questions/subjects/", { params: { exam_type: "usmle" } }),
    getYears: () => apiClient.get("/questions/years/", { params: { exam_type: "usmle" } }),
    getStats: (params: Record<string, unknown> = {}) =>
        apiClient.get("/questions/stats/", { params: { ...params, exam_type: "usmle" } }),

        ...
        <div className="main-content min-h-screen bg-gradient-to-br from-indigo-50/40 via-white to-sky-50/40 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
            ...
            <main className="max-w-[1600px] mx-auto px-4 py-6 grid grid-cols-12 gap-4">
                ...
                <section className="col-span-12 lg:col-span-8 order-1">
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-indigo-900/5 dark:shadow-black/30 border border-indigo-100/60 dark:border-slate-800 overflow-hidden">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {stemImages.map(img => (
                                        <button
                                            ...
                                            className="relative group rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-indigo-400 dark:hover:border-indigo-500 transition-all hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        >
                                            {img.file_url ? (
                                                <img
                                                    src={img.file_url}
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                !isCorrect && !isWrong && isSelected && 'border-indigo-500 bg-indigo-50 dark:bg-indigo-950/40',
                                                !isCorrect && !isWrong && !isSelected && 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-indigo-300 dark:hover:border-indigo-500',
                                            )}
                                        >
                                            <span className={cn(
                                                ...
                                                isCorrect ? 'bg-emerald-600 text-white' :
                                                    isWrong ? 'bg-rose-500 text-white' :
                                                        isSelected ? 'bg-indigo-600 text-white' :
                                                            'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-200 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900 group-hover:text-indigo-700 dark:group-hover:text-indigo-300',
                                            )}>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            {explanationImages.map(img => (
                                                ...
                                                >
                                                    ...
                                                    {img.caption && (
                                                        <div className="px-3 py-2 text-xs text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800/60 border-t border-indigo-100 dark:border-slate-800">
                                                            {img.caption}
                                                        </div>
                                                    )}
                                                </button>
                        ...
                        <details className="border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 px-6 py-3">
                    ...
                    <div className="sticky bottom-0 z-20 mt-4 -mx-4 px-4">
                        <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl shadow-indigo-900/10 dark:shadow-black/40 border border-indigo-100 dark:border-slate-800 p-3 flex items-center gap-2">
            ...
            {paletteOpen && (
                ...
                >
                    ...
                    >
                        <div className="sticky top-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur z-10 px-6 py-4 border-b border-indigo-100 dark:border-slate-800 flex items-center justify-between">

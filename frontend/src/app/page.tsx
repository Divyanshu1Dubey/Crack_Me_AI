  ...
  return (
    <div className="min-h-screen bg-transparent font-sans">
      ...
      <section className="relative px-6 py-20 md:py-24 overflow-hidden border-t border-border/45 bg-slate-950 text-white rounded-[2.5rem] mx-4 sm:mx-6 md:mx-12 my-16 shadow-2xl">
        <div className="absolute right-0 top-0 h-100 w-100 rounded-full bg-linear-to-br from-amber-500/10 to-yellow-500/15 blur-3xl opacity-60 pointer-events-none" />
        <div className="absolute left-0 bottom-0 h-100 w-100 rounded-full bg-linear-to-tr from-cyan-500/10 to-blue-500/15 blur-3xl opacity-60 pointer-events-none" />
        ...
        <div className="mt-16 grid grid-cols-2 gap-4 md:grid-cols-4 pt-8 border-t border-border/50 max-w-5xl mx-auto w-full">
          {stats.map((stat, i) => (
            <div key={i} className="flex flex-col items-center text-center p-3 hover:-translate-y-0.5 transition-transform">
      ...
      <section className="px-4 pb-24 sm:px-6 relative overflow-hidden">
        {/* Glow backdrop */}
        <div className="absolute left-1/2 top-1/2 -z-10 h-125 w-125 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/10 blur-3xl" />

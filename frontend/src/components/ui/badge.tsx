...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  const variants: Record<string, string> = {
    ...
    secondary: "border-transparent bg-secondary text-secondary-foreground dark:bg-slate-700 dark:text-slate-100",
    destructive: "border-transparent bg-destructive text-destructive-foreground",
    outline: "text-foreground border-border dark:border-slate-700 dark:text-slate-200",

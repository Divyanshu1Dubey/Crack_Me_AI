...
export function ComingSoon({ title = 'Coming Soon', message = 'We are working hard to bring this feature to you. Stay tuned!' }: { title?: string, message?: string }) {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center min-h-100 border border-dashed border-gray-300 rounded-2xl bg-gray-50/50 my-6">

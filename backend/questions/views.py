...
class QuestionViewSet(viewsets.ModelViewSet):
    ...
    def reload_fixture(self, request):
        """Temporary endpoint to reload database from fixture (uses a secret)."""
        ...
        try:
            # Delete existing questions to prevent duplicates and load fixture
            Question.objects.all().delete()
            call_command('loaddata', str(fixture_path), verbosity=0)
            return Response({
                'message': 'Fixture reload complete',

...
export default function IniCetPlayer({
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50/40 via-white to-sky-50/40">
            {/* Header */}
            ...
            {zoomImg && (
                ...
                >
                    <button className="absolute top-4 right-4 p-2 rounded-full bg-white/10 text-white hover:bg-white/20" aria-label="Close image viewer">
